...
/***/ function(module, exports) {
	...
	function getShapeIndex(shapes, id) {
	    var shape = shapes.filter(function (shape) { return shape.id === id; })[0];
	...
	function shapeBack(state, action) {
	    ...
	    var new_shapes = state.shapes.slice();
	    _a = [new_shapes[shapeIndex], new_shapes[shapeIndex - 1]], new_shapes[shapeIndex - 1] = _a[0], new_shapes[shapeIndex] = _a[1];
	    return Object.assign({}, state, { shapes: new_shapes });
	    var _a;
	}
